...
class LitecoinTests: XCTestCase {
    ...
    private lazy var addressService = blockchain.getAddressService() as! BitcoinLegacyAddressService
    ...
    func testAddress() {
        ...
        XCTAssertEqual(addressService.makeAddress(from: walletPublicKey), expectedAddress)
    }
    ...
    func testBuildTransaction() {
        ...
        let compressedPubkey = Secp256k1Utils.convertKeyToCompressed(walletPubkey)
        XCTAssertNotNil(compressedPubkey)
            
        let signature = Data(hex: "")
        ...
        let address = addresses.first(where: { $0.type == .plain })?.value
        ...
        txBuilder.unspentOutputs =
            [
                BtcTx(tx_hash: "bcacfe1bc1323e8e421486e4b334b91163925d7edd87133673c3efbd4e3fedae", tx_output_n: 0, value: 10000, script: "76a914ccd4649cdb4c9f8fdb54869cff112a4e75fda2bb88ac"),
                BtcTx(tx_hash: "fa16fbd7f8a150dc723091fd2305eaa07189e869f9133bf3d429efc5ef3f86ff", tx_output_n: 0, value: 10000, script: "76a914ccd4649cdb4c9f8fdb54869cff112a4e75fda2bb88ac")
            ]
        ...
        let txForSign = txBuilder.buildForSign(transaction: tx)
        let txForSend = txBuilder.buildForSend(transaction: tx, signature: signature, hashesCount: txForSign?.count ?? 0)
        
        XCTAssertEqual(txForSign?.filter { $0 == expectedHashToSign1 || $0 == expectedHashToSign2 }.count, 2)
        XCTAssertEqual(expectedSignedTx, txForSend)
    }
